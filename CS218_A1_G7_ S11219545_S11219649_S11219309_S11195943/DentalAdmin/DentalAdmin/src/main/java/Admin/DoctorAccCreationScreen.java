 ...
 */
public class DoctorAccCreationScreen extends JFrame{
    
    private DentalService dentalService;
    private String email;
    
    
    public DoctorAccCreationScreen(DentalService dentalService, String email){
        ...
        registerButton.setPreferredSize(new Dimension(150, 30));
         ...
         registerButton.addActionListener(e -> registerDentist(
            emailField.getText(),
    ...
    private void registerDentist(String email, String firstName, String lastName, String password, String confirmPassword) {
        ...
        try {
            boolean success = dentalService.registerDentist(email, firstName, lastName, password);
            if (success) {
