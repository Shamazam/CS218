...
public class AdminContact {
    ...
    @SerializedName("id")
    private int contactId;  // This is the contact ID
    ...
    private int departmentId;  // The missing field for department ID
    ...
    public String toString() {
        return buildingName;  // You can return any field you want to display in the spinner
    }
}
